function Watch  (game, board, color) {
    ...
    var viewer = new Viewer(board, topside, game.players, mode, game);
    
    self.moved = function (sx, sy, dx, dy) {
        board.move(sx, sy, dx, dy);
    };
    
    self.joined = function (name) { viewer.joined(name) };
    self.parted = function (name) { viewer.joined(name) };
    
    $(window).resize(function () {
        var v = new Viewer(board, topside, game.players, mode, game);
