function Viewer (board) {
    ...
    function project (x,wBottom,wTop,h,c) {
        ...
        //c: center wrt original coordinates, form [c_1,c_2] (if (x,y)=(cx,xy), x coord unchanged. In our case, most likely x_max/2)
        return [(x[0]-c[0])*wTop*y*wBottom + c[0]*wBottom, h*(x[1]-c[1])+c[1]];
    }
