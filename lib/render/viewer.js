...
function Viewer (board, topside, players, mode, moveMakerF) {
    ...
    self.rename = function (oldname, newname) {
        if (players.white.name == oldname) {
            players.white.name = newname;
        }
        if (players.black.name == oldname) {
    ...
    function cellClick(cell,x,y) {
        ...
        if (srcMove) {
            ...
            if (piece && piece.color == 'w' && piece.code == 'p' && srcMove.y == 6 && y == 7) {
            ...
            if (piece && piece.color == 'b' && piece.code == 'p' && srcMove.y == 1 && y == 0) {
