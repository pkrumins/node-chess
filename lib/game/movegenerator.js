...
function MoveGenerator(state,square) {
    ...
    function MoveGeneratorInDirection(direction) {
        var validMoves = [];
    ...
    function RookMoves() {
        ...
        validMoves.concat(MoveGeneratorInDirection('e'));
        validMoves.concat(MoveGeneratorInDirection('w'));
        validMoves.concat(MoveGeneratorInDirection('s'));
        validMoves.concat(MoveGeneratorInDirection('n'));
    ...
    function BishopMoves() {
        ...
        validMoves.concat(MoveGeneratorInDirection('ne'));
        validMoves.concat(MoveGeneratorInDirection('nw'));
        validMoves.concat(MoveGeneratorInDirection('se'));
        validMoves.concat(MoveGeneratorInDirection('sw'));
